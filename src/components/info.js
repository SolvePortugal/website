    ...
    <div>
        ...
        <div className='content'>
            <div className='info'>
                ...
                <div className='texto'>
                    <p>Em 25 de novembro de 2019, nos berços dos departamentos da FCTUC, foi fundada a Solve - Soluções em Engenharia. Inicialmente idealizada por 11 estudantes de engenheira civil e química, a Solve visa ser uma empresa de serviços de consultoria sustentável especializada. Além disso, seu intuito maior é de ajudar a atingir os objetivos do desenvolvimento sustentável da agenda 20/30 da ONU, utilizando de todas competências e aprendizados da FCTUC, a fim de alcançar uma realidade mais sustentável. <br></br><br></br>Hoje a Solve conta com membros de diversas áreas do conhecimento da FCTUC. Todos preparados e treinados para realizar diversas tarefas desde as departamentais até mesmo as de elaboração e execução de projetos, visando sempre atender as necessidades de nossos clientes da melhor forma possível tendo em mente uma visão sustentável.<br></br><br></br>Nossa visão é possuir um padrão de excelência elevado nos nossos serviços de consultoria em engenharia de forma sustentável e criativa.</p>
                </div>
            </div>
